// Adopted by Conrad Nied (conrad.logos@gmail.com)
// Originally from:
// https://code.google.com/p/bibtex-js/source/browse/trunk/src/bibtex_js.js
...
//  value -> value_quotes | value_braces | value_list | key;
//  value_quotes -> '"' .*? '"'; // not quite
//  value_braces -> '{' .*? '}'; // not quite
//  value_list -> '[' .*? ']'; // not quite
